    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="mainNav">
        ...
        <ul class="navbar-nav ms-lg-4 mb-2 mb-lg-0">
          ...
          <li class="nav-item"><a class="nav-link<?= $currentPage==='about'?' active':'' ?>" href="#">About Us</a></li>

          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle<?= $currentPage==='service'?' active':'' ?>" href="#" id="servicesDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Services</a>
          ...
          <li class="nav-item"><a class="nav-link<?= $currentPage==='partners'?' active':'' ?>" href="#">Partners</a></li>
          <li class="nav-item"><a class="nav-link<?= $currentPage==='SuccessStories'?' active':'' ?>" href="#">Success Stories</a></li>
          <li class="nav-item"><a class="nav-link<?= $currentPage==='Pricing'?' active':'' ?>" href="#">Pricing</a></li>
        </ul>
