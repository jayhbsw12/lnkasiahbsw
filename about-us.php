    ...
    <div class="row align-items-start mb-4">
      <div class="col-md-6">
        <h2 class="section-title-about">
          ...
          <br>
          <span class="highlight-techsol">LNK ASIA TECHNOCRAFT</span><br>
          Future
        </h2>
        <p class="mt-2">Here to create technology for a better tomorrow, <br>By Bharat for the world.</p>
      </div>
      <div class="col-md-6">
        <p>
          We are expert in IT / ITES. In today’s rapidly evolving digital age, while Information Technology Enabled Services (ITES) have emerged as a critical component of the global economy, we are passionate about the client’s success by adding value through consulting and technology implementation.
        </p>
        <p>
          Our emerging digital technologies build stronger capabilities & seize growth opportunities. We offer full-cycle technology solutions that streamline your digital transformation journey.
        </p>
        <a href="#" class="btn section-btn">Explore Services</a>
      </div>
    </div>
    ...
    <div class="row g-4">
      ...
      <div class="col-md-3">
        <div class="tab-card text-center h-100">
          ...
          <p class="icon-p">Our mission is to create sustainable value for our customers, by bringing innovative ideas and technologies to address their needs.</p>
        </div>
      </div>
      ...
      <div class="col-md-3">
        <div class="tab-card text-center h-100 active">
          ...
          <p class="icon-p">Our vision is to reduce cost with enhanced data security, effectively respond to dynamic market conditions and growing demands.</p>
        </div>
      </div>
      ...
      <div class="col-md-3">
        <div class="tab-card text-center h-100">
          ...
          <p class="icon-p">Our goal is to achieve the most profitability, competitiveness, and sustainability through optimum scheduling and implementing the technology.</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row align-items-center">
      ...
      <div class="col-md-6">
        <div class="why-text">
          ...
          <p>By bringing innovative ideas and technologies to address customer's needs. We focus on customer delight and exceeding customer expectations is our belief.</p>
          <p>Our customer-centric approach ensures that we deliver solutions that meet your unique needs and exceed your expectations.</p>
          <p>Delivering Quality & Excellence with customer delight</p>
          <a href="#" class="btn section-btn">Contact Us</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <article class="flip-card">
    <div class="flip-inner" tabindex="0" aria-label="More info">
      <div class="flip-face flip-front">
        ...
        <img src="../lnk-asia/assets/images/Parag Soni.png" alt="Parag Soni">
      </div>
      <div class="flip-face flip-back">
        <div class="back-text">
          <!-- <h3>Project One</h3> -->
          <p>He brings over two decades of industry experience. He is also the expert in ERP, Cloud and strategic alliances.</p>
          <br>
          <p>His passion for excellence and his years of experience in the software industry have been instrumental in our success</p>
        </div>
      </div>
    </div>
    <div>
  ...
  <article class="flip-card">
    <div class="flip-inner" tabindex="0" aria-label="More info">
      ...
      <div class="flip-face flip-back">
        <div class="back-text">
          <!-- <h3>Project Two</h3> -->
          <p>He brings over two decades of telecom and consulting experience. His expertise brings value addition to project and new acquisitions.</p>
          <br>
          <p>He brings his extensive experience to our team, providing valuable insights and driving our financial success.</p>
        </div>
      </div>
    </div>
    <div>
  ...
  <article class="flip-card">
    <div class="flip-inner" tabindex="0" aria-label="More info">
      ...
      <div class="flip-face flip-back">
        <div class="back-text">
          <!-- <h3>Project Three</h3> -->
          <p>Our team of experts is dedicated to providing top-notch services to our clients. We strive to exceed expectations and deliver exceptional results.</p>
          <br>
          <p>His background in IT and system management makes him a pro at company operations. He also handles the advisory team.</p>
        </div>
      </div>
    </div>
    <div>
