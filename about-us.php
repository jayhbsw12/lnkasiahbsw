      ...
      <div class="row g-4">
        ...
        <div class="col-md-4">
          <div class="feature-card h-100 text-start">
            ...
            <p>We leverage the latest advancements in AI to deliver innovative solutions that keep you ahead of the
              competition.</p>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="feature-card h-100 text-start">
            ...
            <p>Our AI strategies are customized to meet the unique needs of your business, ensuring optimal results and
        ...
        <div class="col-md-4">
          <div class="feature-card h-100 text-start">
            ...
            <p>Industry-leading AI experts with deep technical knowledge and practical experience in implementing AI
              across industries.</p>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="feature-card h-100 text-start">
            ...
            <p>We turn complex data into actionable insights, helping you make informed decisions that drive business
              success.</p>
          </div>
        </div>
